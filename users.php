    ...
    <div class="col-sm-4 col-md-3">
      <div class="well text-center">
        ...
        <div class="text-left" style="margin-top: 10px;">
          ...
          <?php endfor ?>
          <li style="margin-top: 5px;">Average per GP<span class="pull-right"><?=($gpsFinishedAmount) ? round($userResultsTotal[0]/$gpsFinishedAmount, 2) : null ?></span></li>
          <li>Average per Rider<span class="pull-right"><?=($gpsFinishedAmount) ? round($userResultsTotal[0]/$gpsFinishedAmount/3, 2) : null ?></span></li>
          <li>Finished Races<span class="pull-right"><?=$userResultsTotal[4]?></span></li>
          <li>Overall Position<span class="pull-right"><?=($gpsFinishedAmount) ? $userResultsTotal[5].' / '.$validUsers : null ?></span></li>
        </div>
      ...
      <div class="col-sm-4 col-md-3">
        <div class="well">
            ...
            <li><a href="/riders.php?id=<?=$pick?>">
              ...
              <span class="pull-right">
                <?php //if ($hasGPFinished) :
                  $result = getRiderResultsInGP($pick, $gp_id, $connect);
                  $podium = $result[1];
                  if ($podium) : ?>
          ...
          //if ($hasGPFinished) :
            ...
            <li>Average<span class="pull-right"><?=round($userResultsInGP[0]/3, 2)?></span></li>
            <li>Finished Races<span class="pull-right"><?=$userResultsInGP[4]?></span></li>
            <li>Position<span class="pull-right"><?=$userResultsInGP[5]?> / <?=$validUsers?></span></li>
          <?php //endif ?>
        </div>
      </div>
    <?php endforeach;
            ...
            <form action="" method="post">
                ...
                <div class="row form-group">
                  <div class="col-xs-12">
                    <div class="input-group">
                      <span class="input-group-addon"><img src="/graphics/<?=($userPicks) ? 'nations/'.getItem('nation_id', 'riders', 'id', $userPicks['pick_'.$i], $connect) : 'sgp_logo' ?>.png" width="16px" /></span>
              ...
              <div class="row form-group">
                <div class="col-xs-12">
                  ...
                  <button type="submit" name="<?=($userPicks) ? 'update_picks' : 'insert_picks' ?>" class="btn btn-success btn-sm text-uppercase" style="width: 100%;">
